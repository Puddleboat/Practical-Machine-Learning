...
Data for this project was sourced from the following locations

Training set - https://d396qusza40orc.cloudfront.net/predmachlearn/pml-training.csv

Test set - https://d396qusza40orc.cloudfront.net/predmachlearn/pml-testing.csv

These 2 files were downloaded and saved into a "Data" folder in the current working directory
...
![plot of correlation matrix](corrplot.png) 
...
![plot of treemodel](treeplot.png) 